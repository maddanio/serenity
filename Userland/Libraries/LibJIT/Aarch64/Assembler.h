...
struct Aarch64Label : public Interface::LabelInterface<Aarch64Label, Aarch64Assembler> {
    using Base = Interface::LabelInterface<Aarch64Label, Aarch64Assembler>;
    friend Base;
    struct LabelOffset {
        size_t offset;
...
struct Aarch64Assembler : public Interface::AssemblerInterface<Aarch64Assembler, Reg, Aarch64Label> {
    using Base = Interface::AssemblerInterface<Aarch64Assembler, Reg, Aarch64Label>;
    using Operand = typename Base::Operand;
    using Extension = typename Base::Extension;
    friend Aarch64Label::Base;
    friend Base;
    friend struct Aarch64Label;
...
inline void Aarch64Label::link_to(Aarch64Assembler& assembler, size_t link_offset)
{
...
inline void Aarch64Label::add_jump(Aarch64Assembler& assembler, LabelOffset offset)
{
...
inline void Aarch64Label::link_jump(Aarch64Assembler& assembler, LabelOffset offset_in_instruction_stream)
{
